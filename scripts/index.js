...
const profilePopupInputName = document.querySelector('.popup-profile__input_name');
const profilePopupInputJob = document.querySelector('.popup-profile__input_job');
